...
/** Mapper class that provides all tags to handler.
  *
  * With this class set in context, handler can recognize tags specific to html s.t. div, br, etc.
  * ref: https://stackoverflow.com/questions/19368018/parsing-html-elements-in-apache-tika
  */
