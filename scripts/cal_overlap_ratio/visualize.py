...
def visualize(args):
    ...
    def draw(overlap_ratio, title, colorscale):
        ...
        fig.write_image(f"{args.output_path}{title.split(' ')[0]}.png")
        fig.show()
        
    draw(overlap_ratio1, "overlap_ratio1 = len(dump_1 & dump_2) / len(dump_1)", "YlGnBu")
    draw(overlap_ratio2, "overlap_ratio2 = len(dump_1 & dump_2) / len(dump_2)", "YlGnBu")
    draw(overlap_ratio3, "overlap_ratio3 = len(dump_1 & dump_2) / len(dump_1 | dump_2) ", "YlGnBu")
